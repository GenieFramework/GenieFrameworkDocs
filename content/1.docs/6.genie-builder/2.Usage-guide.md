...
To create a new Genie app, click on the blue + sign in the GENIE tab. You'll be prompted to name your app and enter a path to save it. After a few moments, the app will be created and loaded, with the main window displaying the UI editor.
...
After you've added the code, load the app into Genie Builder by picking the load app icon in the GENIE tab to the left. This will instantiate the packages from the Project.toml file, and run the app.

<img class="border-gray-300" style="display:block;width:35%;max-width:100%;margin-left:auto;margin-right:auto" src="/assets/docs/gb/loadapp.png">

## Editing code

Genie Builder is an extension that adds a visual UI editor and some features for managing Genie apps. Other than this, it behaves exactly as VSCode, so you can use it as you would use any other VSCode instance.
