...
<iframe 
    style="width: 100%; max-width: 560px; height: 315px;margin-left:auto;margin-right:auto" 
...
You can run Genie Builder on JuliaHub, or locally on your machine. To run it on Juliahub, follow the instructions [here](/docs/genie-builder/using-gb-on-juliahub). To run it locally, follow the instructions below.
