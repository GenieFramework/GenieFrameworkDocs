...
To create a basic webpage with dynamic content, see the [Adding dynamic pages](/guides/adding-dynamic-pages) guide.

To build an interactive **dashboard**, check out the [First dashboard](/guides/first-dashboard) guide.

To build a multipage app, head over to the [First multipage app](/guides/first-multipage-app) guide.

 For more advanced features see the [API](/guides/creating-an-api) guide and the [Reference](/reference) section.
