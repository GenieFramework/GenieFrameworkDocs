...
The first requirement is to have Julia installed on your system, you can find platform-specific instructions [here](https://julialang.org/downloads/platform). Make sure **Julia is on your PATH** so that it can be executed from VSCode's terminal.
