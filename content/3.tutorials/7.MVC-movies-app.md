---
title: MVC movies app
image: /assets/tutorials/mvc-movies-app/preview2.png
description:  Develop a feature rich MVC app including user facing web pages, a REST API endpoint, and user authentication.
tags: [MVC, API, database]
published: true
toc: true
---
# MVC movies app

This is a complete walk-through of developing a feature rich model-view-controller (MVC) app with Genie, including both user facing web pages,
